...
async function scanJob(
  ...
  for (const listing of listings) {
    ...
    // A broad eBay search may surface the same listing for multiple Releases.
    // Preserve an existing exact-Release assignment and reject it locally for
    // this job instead of failing the whole Release scan.
    if (
