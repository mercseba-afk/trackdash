...
// 2. Seller diversity is a publication-quality factor. Repeated sales from one
//    known seller prove sell-through, but do not by themselves establish broad
//    European market agreement. A single-seller cluster needs independent
//    current retail corroboration before it can headline as Market Value.
