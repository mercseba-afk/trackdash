...
insert into public.market_aggregate_observations (
  ...
  1,1,2200,2200,2200,
  1,0,0,
  'JPY',11.86,0.00539229,date '2026-05-29',
  'indicative',
  ...
  jsonb_build_object(
    ...
    'condition_observed','kit sale; closed result does not expose a full transaction-detail condition audit',
    'ended_on','2026-05-31',
...
insert into public.market_aggregate_observations (
  ...
  1,1,2900,2900,2900,
  0,1,0,
  'JPY',15.76,0.00543419,date '2026-06-23',
  'indicative',
  ...
  jsonb_build_object(
    ...
    'condition_observed','closed result does not expose a full transaction-detail condition audit',
    'ended_on','2026-06-23',
